...
export default function LoginPage() {
  ...
  // ⚠️ Credenciais reais do seed.py (seed cria jackson/12345678 e joao/12345678)
  function fillUser()  { setUsername('joao');    setPassword('12345678'); setError('') }
  function fillAdmin() { setUsername('jackson'); setPassword('12345678'); setError('') }
      ...
      <div className="login-right">
        <div className="login-card">
          ...
          <form onSubmit={handleSubmit}>
            ...
            {error && (
              <p style={{ fontSize: 12, color: 'var(--color-red)', marginBottom: '.75rem' }}>
                {error}
              </p>
            )}
